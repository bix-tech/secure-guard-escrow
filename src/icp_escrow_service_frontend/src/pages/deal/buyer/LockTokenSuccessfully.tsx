...
const CreateDealSuccessful: React.FC<SidebarProps> = ({ isSidebarActive }) => {
    ...
    return (
        <div className="container-fluid mt-1 d-flex flex-column p-3">
            <div className={`card p-5 margin-y-5 mobile-font-size-8px ${isSidebarActive ? 'not-full-width' : 'full-width'}`}>
                <div className="card-body text-center">
                    <div className="mb-4">
                        <img src="/create_deals.png" className="create-deals-image" alt="Image" />
                        <p className="mt-2">You’ve Successfully locked token to a deal, please wait for seller to submit deliverables before you can confirm this deal.</p>
                    </div>
                    <div>
